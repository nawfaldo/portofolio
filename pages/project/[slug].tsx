...
const project = () => {
  ...
  const { title, description, images, fitures, technologies } =
    getProject(slug);
      ...
      <div className='mt-[50px] mx-[100px] space-y-7'>
            ...
            <div className='bg-gray-200 rounded'>
              {i == show || (show == null && i == images[0]) ? (
                <div className='w-[150px] h-[75px] flex'>
                  ...
                  >
                    <path
                      d='M0,29.364v413.887h472.615V29.364H0z M134.754,101.162c22.657,0,41.025,18.368,41.025,41.026
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 space-y-10 lg:space-y-0'>
          <div className='space-y-7'>
            <h2 className='font-Poppins text-4xl text-[#A0D995]  mt-10'>
              Fitures
            </h2>
          ...
          <div className='space-y-7'>
            ...
            <div className='space-y-3'>
              {technologies.map((i: any) => (
                <h3 className='font-Poppins text-2xl'>{i}</h3>
              ))}
            </div>
          </div>
        </div>
