    ...
    <div className="">
      ...
      {project.map((p) => (
        <div className="mt-[50px] mx-[100px] space-y-7">
          ...
          <div className="relative h-[500px] w-[900px] shadow rounded-xl">
            <Image
              src={show !== null ? show : p.images[0]}
              layout="fill"
              objectFit="cover"
              className="rounded-xl"
            />
          </div>
          <div className="overflow-x-auto flex space-x-5 pb-10">
            {p.images.map((img) => (
              <div
                className={
                  show == img
                    ? "relative h-[100px] w-[150px] rounded-md cursor-pointer bg-gray-200"
                    : "relative h-[100px] w-[150px] shadow hover:shadow-xl rounded-md cursor-pointer"
                }
                onClick={() => setShow(img)}
              >
                <Image
