...
const Contact = () => {
  ...
  return (
    <div
      id='contact'
      className='px-[30px] md:px-[70px] lg:px-[100px] mb-[100px] pb-5 pt-10 bg-[#A0D995]'
    >
      <div className='grid grid-cols-1 xl:grid-cols-2 space-y-[70px] xl:space-y-0'>
        <div>
          <div className='space-y-5'>
            <h1 className='font-Oswald text-white text-6xl'>CONTACT</h1>
            <div className='space-y-3'>
              <div className='flex items-center flex-wrap space-y-3 w-max-[600px] mr-10'>
